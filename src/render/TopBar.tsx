...
import { Book, Settings } from "@hoardodile/ui/icons/registry"
import { useEffect, useState } from "react"
import { useTranslation } from "../i18n"
import type { MangaSettings } from "../prefs"
import { MangaSettingsPopover } from "./SettingsPopover"

/**
 * Reader chrome: chapter label with directory button, page indicator
 * with jump field, the original/preview switch and a settings popover
 * (mode, direction, spread/fit, background and page comments all live
 * there). All surfaces follow the host theme via design-system tokens.
 */
...
export function MangaTopBar(props: MangaTopBarProps) {
	...
	return (
		<div className="h-nav shrink-0 border-b border-border bg-background px-2">
