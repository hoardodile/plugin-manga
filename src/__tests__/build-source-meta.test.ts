...
import type { ProbeResult } from "@hoardodile/sdk-server"
...
function createFixture(
	...
	const probes: Readonly<Record<string, ProbeResult>> | undefined =
		probe === undefined
			? undefined
			: {
					"": {
	...
	fixture.setConfig({ files, probes })
	return fixture
}
...
describe("manga sourceMeta", () => {
	...
	it("ignores non-image files when collecting previews", async () => {
		const fixture = createFixture(
